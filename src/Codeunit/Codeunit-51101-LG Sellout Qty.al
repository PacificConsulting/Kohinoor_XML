codeunit 51101 "Sell Out Qty"
{
    ...
    begin
        ...
        IF RecItem.FindSet() then
            repeat
                ...
                //VL.SetRange("Posting Date", 20230801D, 20230831D);
        ...
        ReadTXT := 'KTVP_Sellout_Qty' + '_' + Format(Today) + '.XML';
        //ReadTXT := 'LG Sellout August 2023.XML';// + '_' + Format(Today);
    ...
    procedure XMLCreationDate(/*SIH: Record 112*/)
    var
        XMLDoc: XmlDocument;
        XMLDecl: XmlDeclaration;
        RootNode: XmlElement;
    ...
    begin
        ...
        IF RecItem.FindSet() then
            repeat
                ...
                //VL.SetRange("Item No.", SalesInvLine."No.");
                //VL.SetRange("Document Type", VL."Document Type"::"Sales Invoice");
                VL.SetRange("Posting Date", GLSetup."LG Sales File Date");
                //VL.SetRange("Posting Date", 20230801D, 20230831D);
                VL.SetRange("Item No.", RecItem."No.");
                if VL.FindFirst() then
                    repeat
        ...
        Ostr.WriteText(WriteTxt);
        Istr.ReadText(WriteTxt);
        ReadTXT := 'KTVP_Sellout_Qty' + '_' + Format(GLSetup."LG Sales File Date") + '.XML';
        //ReadTXT := 'LG Sellout August 2023.XML';// + '_' + Format(Today);
        // DownloadFromStream(Istr, '', '', '', ReadTXT);
